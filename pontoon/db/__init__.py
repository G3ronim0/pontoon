...
class IContainsCollate(IContains):
    """
    Searching through translations may produce invalid results if you don't specify a correct
    database collation.
    This filter require to pass a tuple with search phrase and collation to apply.
    e.g.
    translation__string__icontains_collate=('search_phrase', 'tr_tr')
